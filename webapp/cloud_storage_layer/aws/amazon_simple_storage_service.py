...
from webapp.project_library_layer.credentials.credential_data import get_aws_credentials
from webapp.project_library_layer.initializer.initializer import Initializer
from webapp.exception_layer.clound_storage_exception.aws_exception import AWSException
import sys, os
import dill
import io
import pandas as pd
...
class AmazonSimpleStorageService:
    ...
    def __init__(self, bucket_name=None, region_name="ap-south-1"):
        """
        ...
        try:
            ...
            if self.bucket_name not in self.list_buckets()['bucket_list']:
