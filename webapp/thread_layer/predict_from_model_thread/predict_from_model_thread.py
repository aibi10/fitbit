...
from webapp.entity_layer.email_sender.email_sender import EmailSender
from webapp.entity_layer.predict_from_model.prediction_from_model import PredictFromModel, PredictFromModelException
...
from webapp.project_library_layer.datetime_libray.date_time import get_date, get_time
...
class PredictFromModelThread(Thread):
    ...
    def __init__(self, project_id, executed_by, execution_id, log_writer=None):
        """
