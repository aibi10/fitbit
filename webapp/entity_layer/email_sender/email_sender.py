...
from webapp.exception_layer.generic_exception.generic_exception import GenericException as EmailSenderException
import smtplib
from email.mime.text import MIMEText
import sys
from webapp.project_library_layer.credentials import credential_data
